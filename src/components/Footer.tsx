export function Footer() {
  return (
    <footer className="bg-forest-deep py-13 pb-7 text-[#C4CDC5]">
      <div className="mx-auto flex max-w-[1080px] flex-wrap justify-between gap-6 px-7">
        <div>
          <div className="font-serif text-[19px] text-white">AniCa Happy Nest Campsite</div>
      ...
      <div className="mx-auto mt-10 max-w-[1080px] border-t border-paper/10 px-7 pt-5 text-xs text-[#7C8A76]">
        This page is a visual test build — pricing and rules pulled directly from AniCa Happy
