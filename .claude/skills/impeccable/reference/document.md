...
If a `DESIGN.md` already exists, **do not silently overwrite it**. Show the user the existing file first. Ask the user directly if unclear. The choice is refresh, overwrite, or merge.
